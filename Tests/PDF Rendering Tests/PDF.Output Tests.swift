...
struct `PDF.Output Tests` {
    ...
    func `Writes graphics PDF to tmp`() throws {
        ...
        operations.append(.graphics(.rectangle(
            PDF.Rect(x: 72, y: 130, width: 100, height: 50),
            fill: .red,
            stroke: .black,
            strokeWidth: 1
        )))
        ...
        operations.append(.graphics(.rectangle(
            PDF.Rect(x: 192, y: 130, width: 100, height: 50),
            fill: .green,
            stroke: .black,
            strokeWidth: 1
        )))
        ...
        operations.append(.graphics(.rectangle(
            PDF.Rect(x: 312, y: 130, width: 100, height: 50),
            fill: .blue,
            stroke: .black,
            strokeWidth: 1
        )))
        ...
        // CMYK rectangle
        operations.append(.graphics(.rectangle(
            PDF.Rect(x: 72, y: 200, width: 100, height: 50),
        ...
        operations.append(.graphics(.rectangle(
            PDF.Rect(x: 192, y: 200, width: 100, height: 50),
        ...
        operations.append(.graphics(.rectangle(
            PDF.Rect(x: 312, y: 200, width: 100, height: 50),
