...
struct `PDF.Output Tests` {
    ...
    func `Writes graphics PDF to tmp`() throws {
        // Create a page with graphics operations
        let mediaBox = ISO_32000.Rectangle.a4
        
        // Build operations manually to include graphics
        ...
        operations.append(.graphics(.line(
            from: PDF.Point(x: 72, y: 110),
            to: PDF.Point(x: 523, y: 110),
            color: .black,
            width: 1
        )))
        ...
        operations.append(.graphics(.rectangle(
            PDF.Rectangle(x: 72, y: 130, width: 100, height: 50),
            fill: .red,
            stroke: .black,
            strokeWidth: 1
        )))
        ...
        operations.append(.graphics(.rectangle(
            PDF.Rectangle(x: 192, y: 130, width: 100, height: 50),
            fill: .green,
            stroke: .black,
            strokeWidth: 1
        )))
        ...
        operations.append(.graphics(.rectangle(
            PDF.Rectangle(x: 312, y: 130, width: 100, height: 50),
            fill: .blue,
            stroke: .black,
            strokeWidth: 1
        )))
        ...
        // CMYK rectangle
        operations.append(.graphics(.rectangle(
            PDF.Rectangle(x: 72, y: 200, width: 100, height: 50),
            fill: .cmyk(c: 1, m: 0, y: 0, k: 0),  // Cyan
            stroke: nil,
            strokeWidth: 0
        )))
        
        operations.append(.graphics(.rectangle(
            PDF.Rectangle(x: 192, y: 200, width: 100, height: 50),
            fill: .cmyk(c: 0, m: 1, y: 0, k: 0),  // Magenta
            stroke: nil,
            strokeWidth: 0
        )))
        
        operations.append(.graphics(.rectangle(
            PDF.Rectangle(x: 312, y: 200, width: 100, height: 50),
            fill: .cmyk(c: 0, m: 0, y: 1, k: 0),  // Yellow
            stroke: nil,
            strokeWidth: 0
        )))
        ...
        let page = PDF.Page(mediaBox: mediaBox, operations: operations)
