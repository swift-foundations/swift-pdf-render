// PDF.Render.swift
// Rendering namespace with operations and results.

public import PDF_Standard

extension PDF {
    /// Namespace for rendering operations and results.
    public enum Render {}
}
...
extension PDF.Render.Result {
    ...
    public mutating func advanceHeight(by amount: PDF.UserSpace.Height) {
