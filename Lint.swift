...
// ===----------------------------------------------------------------------===//
//
// This source file is part of the swift-pdf-render open source project
//
// Copyright (c) 2026 Coen ten Thije Boonkkamp and the swift-pdf-render project authors
